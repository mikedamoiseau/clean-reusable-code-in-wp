 ...
 * @package Acme\Cpt
 *
 * Class responsible for the registration of the custom post type Product
 */
class ProductCpt
{
    /** @var string CPT name */
    const NAME = 'acme-product';

    /**
     * ProductCpt constructor.
     */
    ...
    {
        $labels = [
            'name'                  => _x('Products', 'Post Type General Name', 'acme'),
            'singular_name'         => _x('Product', 'Post Type Singular Name', 'acme'),
            'menu_name'             => __('Products', 'acme'),
            'name_admin_bar'        => __('Product', 'acme'),
